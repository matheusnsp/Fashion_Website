document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btnNext) {
        btnNext.addEventListener('click', () => {
            ...
            if (currentStep < steps.length - 1) {
                // Transição vertical suave para evitar saltos bruscos
                gsap.to(currentStepEl, { 
                    ...
                    onComplete: () => {
                        ...
                        nextStepEl.style.display = 'flex'; // Garante o flexbox para o layout estável
    ...
    function finalizarDiagnostico() {
        ...
        // Calcular porcentagens para todos os estilos
    ...
    function renderizarResultado(dna, sec1, sec2, todos) {
        ...
        // Removi o background sólido e adicionei backdrop-filter para efeito de vidro (opcional)
        const resultadoHTML = `
    ...
    window.baixarDossie = function() {
        ...
        // O segredo está aqui: backgroundColor define a cor do fundo APENAS na imagem gerada
        html2canvas(area, {
